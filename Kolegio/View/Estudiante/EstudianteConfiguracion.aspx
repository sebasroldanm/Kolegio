<%@ Page Title="" Language="C#" MasterPageFile="~/View/Estudiante/MasterEstudiante.master" AutoEventWireup="true" CodeFile="~/Controller/Estudiante/EstudianteConfiguracion.aspx.cs" Inherits="View_Estudiante_EstudianteConfiguracion" %>
        ...
        <div class="auto-style1" style="margin: -535px 0px 0px 365px;">
            <div class="form-group">
                ...
                <div class="form-inline" role="form">
                    ...
                    <asp:RegularExpressionValidator ID="REV_contrasenia" runat="server" ControlToValidate="tb_contrasenia" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-Z0-9ñÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White"></asp:RegularExpressionValidator>
                </div>
                <div class="form-inline" role="form">
