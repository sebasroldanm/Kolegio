...
namespace Datos
{
    public class DUser
    {
        ...
        public DataTable actualziarContrasena(UContrasenia datos)
        {
            DataTable Usuario = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarUsuarios(UUser dat)
        {
        ...
        public DataTable obtenerAcudiente(UUser dat)
        {
            DataTable Usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obtenerUsuarioMod(UUser dat)
        {
            DataTable Usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable EditarUsuario(UUser datos)
        {
        ...
        public DataTable traerEstudiante(UUser datos)
        {
        ...
        public DataTable insertarEstudiante(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable validar_usuarioadmin(UUser dat)
        {
            DataTable Usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable editarConfig(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarObservacion(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obtenerHora(UUser reg)
        {
            DataTable Dep = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarCursoMateria(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable cerrarSession(UUser datos)
        {
            DataTable Usuario = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarMateria(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obtener_MatCur(UUser reg)
        {
        ...
        public DataTable insertarNotaMateria(UUser dat)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarEstudianteCurso(UUser dat)
        {
            DataTable Usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable editarOnce(UUser dat)
        {
            DataTable An = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obteneridCurso(UUser dat)
        {
            DataTable Usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obtenerNota(UUser dat)
        {
            DataTable An = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable insertarNota(UUser dat)
        {
            DataTable An = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable obtenerCursoEst(UUser dat)
        {
            DataTable An = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        public DataTable editarInicio(UUser datos)
        {
        ...
        public DataTable editaFinaño(UUser enc)
        {
            DataTable usua = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
